    ...
    <div className='Trans_main' >
       ...
       <div className="container">
        <div className="row">
          ...
          <div class="dropdown">
  <button class="btn btn-secondary dropdown-toggle gre " type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">
 <span className='m-0 align'>   Sell Tokens <span className='dis'>jjheflskfjskjlkjflnfkwnfckwijhfkfhwfjlfkjwlfjlwjflwjflwjflfjljlfjjlfjlfjlfjlfjwfjlfj2qlfjq2lfjflj2fnjng,mbg.,mnbgfkhjbkfnbivunbvmnbvukefjbiue,kmbv</span></span>
  </button>
  <ul class="dropdown-menu dropdown-menu-dark wid" aria-labelledby="dropdownMenuButton2">
    <li><a class="dropdown-item active" href="#">Sell Tokens</a></li>
    <li><a class="dropdown-item" href="#">Buy Tokens</a></li>
    <li><a class="dropdown-item" href="#">Withdraw Tokens</a></li>
